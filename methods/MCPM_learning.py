...
def MCPM_learning(xtrain, xtest, ytrain, task_features, kernel_type, prior_weights, point_estimate, ytrain_non_missing_index, 
	...
	if prior_weights == "GP":
		likelihood = mcpm.likelihoods.Lik_MCPM_GP(ytrain_non_missing_index = ytrain_non_missing_index,
													...
													num_tasks = n_tasks, num_latent = num_latent, trainable_offset = True)
